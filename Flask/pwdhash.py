...
def convertStringToHash(password):
    password = 'Test12'
    ...
    database = DbClass()
    database.insertHashPswd('', hash_string, salt_string)
    # uitvoeren & klaar!
    print('klaar')
...
def verify_credentials(username, password):
    ...
    sql = 'SELECT pwd_hash, pwd_salt FROM db_weerstation.gebruiker WHERE username=%(check_name)s;'
    params = {
        'check_name': username,
    }
